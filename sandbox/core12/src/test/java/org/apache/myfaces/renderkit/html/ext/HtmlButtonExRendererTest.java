...
public class HtmlButtonExRendererTest extends AbstractTomahawkViewControllerTestCase {
    ...
    public HtmlButtonExRendererTest(String name) {
        super(name);
    }
    
    public static Test suite() {
        return new TestSuite(HtmlButtonExRendererTest.class);
    }
