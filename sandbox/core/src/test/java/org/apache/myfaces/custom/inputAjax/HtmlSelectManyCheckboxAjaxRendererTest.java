...
public class HtmlSelectManyCheckboxAjaxRendererTest extends AbstractTomahawkViewControllerTestCase
{
    private MockResponseWriter writer ;
    private HtmlSelectManyCheckboxAjax selectManyCheckbox;

    public HtmlSelectManyCheckboxAjaxRendererTest(String name)
    {
        super(name);
    }
    
    public static Test suite() {
        return new TestSuite(HtmlSelectManyCheckboxAjaxRendererTest.class);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        selectManyCheckbox = new HtmlSelectManyCheckboxAjax();
