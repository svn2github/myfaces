...
public class HtmlSelectBooleanCheckboxAjaxRendererTest extends AbstractTomahawkViewControllerTestCase
{
    private MockResponseWriter writer ;
    private HtmlSelectBooleanCheckboxAjax selectBooleanCheckbox;

    public HtmlSelectBooleanCheckboxAjaxRendererTest(String name)
    {
        super(name);
    }
    
    public static Test suite() {
        return new TestSuite(HtmlSelectBooleanCheckboxAjaxRendererTest.class);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        selectBooleanCheckbox = new HtmlSelectBooleanCheckboxAjax();
