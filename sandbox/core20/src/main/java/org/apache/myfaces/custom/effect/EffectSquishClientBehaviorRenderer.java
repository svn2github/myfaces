...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectSquishBehavior")
...
public class EffectSquishClientBehaviorRenderer extends ClientBehaviorRenderer
{
    ...
    {
        AbstractEffectSquishClientBehavior effectBehavior = (AbstractEffectSquishClientBehavior) behavior;
