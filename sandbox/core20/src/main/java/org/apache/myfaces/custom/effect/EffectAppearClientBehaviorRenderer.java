...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectAppearBehavior")
...
public class EffectAppearClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectAppearClientBehavior effectBehavior = (AbstractEffectAppearClientBehavior) behavior;
