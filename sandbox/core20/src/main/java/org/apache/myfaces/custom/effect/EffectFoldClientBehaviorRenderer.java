...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectFoldBehavior")
...
public class EffectFoldClientBehaviorRenderer extends ClientBehaviorRenderer
{
    ...
    {
        AbstractEffectFoldClientBehavior effectBehavior = (AbstractEffectFoldClientBehavior) behavior;
