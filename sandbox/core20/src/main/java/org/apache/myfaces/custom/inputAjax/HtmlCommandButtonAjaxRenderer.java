...
public class HtmlCommandButtonAjaxRenderer extends HtmlButtonRenderer implements AjaxRenderer
{
    ...
    protected StringBuffer buildOnClick(UIComponent uiComponent, FacesContext facesContext, ResponseWriter writer, List<UIParameter> params) throws IOException {
        String clientId = uiComponent.getClientId(facesContext);
        String submitFunctionStart = AjaxRendererUtils.JS_MYFACES_NAMESPACE + "ajaxSubmit3('" + clientId + "');";

        StringBuffer buf = super.buildOnClick(uiComponent, facesContext, writer, params);
