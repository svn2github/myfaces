...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectScrollToBehavior")
...
public class EffectScrollToClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectScrollToClientBehavior effectBehavior = (AbstractEffectScrollToClientBehavior) behavior;
