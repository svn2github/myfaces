...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectGrowBehavior")
...
public class EffectGrowClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectGrowClientBehavior effectBehavior = (AbstractEffectGrowClientBehavior) behavior;
