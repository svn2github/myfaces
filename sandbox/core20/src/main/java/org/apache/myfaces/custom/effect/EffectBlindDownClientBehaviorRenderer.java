...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectBlindDownBehavior")
...
public class EffectBlindDownClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectBlindDownClientBehavior effectBehavior = (AbstractEffectBlindDownClientBehavior) behavior;
