...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectSlideUpBehavior")
...
public class EffectSlideUpClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectSlideUpClientBehavior effectBehavior = (AbstractEffectSlideUpClientBehavior) behavior;
