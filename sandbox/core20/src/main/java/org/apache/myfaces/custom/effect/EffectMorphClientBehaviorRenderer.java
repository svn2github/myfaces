...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectMorphBehavior")
...
public class EffectMorphClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectMorphClientBehavior effectBehavior = (AbstractEffectMorphClientBehavior) behavior;
