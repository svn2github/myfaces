...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectShowBehavior")
@ResourceDependency(library="oam.custom.prototype", name="prototype.js")
public class EffectShowClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectShowClientBehavior effectBehavior = (AbstractEffectShowClientBehavior) behavior;
