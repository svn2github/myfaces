...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectFadeBehavior")
...
public class EffectFadeClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectFadeClientBehavior effectBehavior = (AbstractEffectFadeClientBehavior) behavior;
