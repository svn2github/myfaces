...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectOpacityBehavior")
...
public class EffectOpacityClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectOpacityClientBehavior effectBehavior = (AbstractEffectOpacityClientBehavior) behavior;
