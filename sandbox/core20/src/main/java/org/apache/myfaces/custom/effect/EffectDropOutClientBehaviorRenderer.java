...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectDropOutBehavior")
...
public class EffectDropOutClientBehaviorRenderer extends ClientBehaviorRenderer
{
    ...
    {
        AbstractEffectDropOutClientBehavior effectBehavior = (AbstractEffectDropOutClientBehavior) behavior;
