...
public class HtmlAccordionPanelRenderer extends HtmlGroupRenderer implements ComponentSystemEventListener
{
    private static String ACCORDION_LIBRARY = "oam.custom.accordion";
    
    public void processEvent(ComponentSystemEvent event )
    {
        HtmlAccordionPanel component = (HtmlAccordionPanel) event.getComponent();
        String javascriptLocation = (String)component.getAttributes().get(JSFAttr.JAVASCRIPT_LOCATION);
        if(javascriptLocation == null)
        {
            FacesContext context = FacesContext.getCurrentInstance();
            TomahawkResourceUtils.addOutputScriptResource(context, ACCORDION_LIBRARY, "dpdump.js");
            //TomahawkResourceUtils.addOutputScriptResource(context, ACCORDION_LIBRARY, "prototype.js");
            TomahawkResourceUtils.addOutputScriptResource(context, "oam.custom.prototype", "prototype.js");
            TomahawkResourceUtils.addOutputScriptResource(context, ACCORDION_LIBRARY, "rico.js");
            TomahawkResourceUtils.addOutputScriptResource(context, ACCORDION_LIBRARY, "toggler.js");
            TomahawkResourceUtils.addOutputScriptResource(context, ACCORDION_LIBRARY, "customRico.js");
        }
    }
