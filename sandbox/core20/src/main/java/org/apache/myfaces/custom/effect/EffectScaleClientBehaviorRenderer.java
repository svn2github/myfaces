...
@JSFClientBehaviorRenderer(
        ...
        type = "org.apache.myfaces.custom.effect.EffectScaleBehavior")
...
public class EffectScaleClientBehaviorRenderer extends ClientBehaviorRenderer
{
    /**
    ...
    {
        AbstractEffectScaleClientBehavior effectBehavior = (AbstractEffectScaleClientBehavior) behavior;
