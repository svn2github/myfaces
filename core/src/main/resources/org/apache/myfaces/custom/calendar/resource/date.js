...
// prefix, eg org.apache.myfaces.dateformat.SimpleDateFormatter_foo().
...
org.apache.myfaces.dateformat = org.apache.myfaces.dateformat || {};

if (!org.apache.myfaces.dateformat.DateFormatSymbols) {
// Constructor for DateFormatSymbols class
    org.apache.myfaces.dateformat.DateFormatSymbols = function () {
...
// Constructor for ParserContext class
    org.apache.myfaces.dateformat.ParserContext = function (dow) {
        this.newIndex = 0;
        this.invalid = false;
...
// constructor for WeekDate class
    org.apache.myfaces.dateformat.WeekDate = function (year, week) {
        this.year = year;
        this.week = week;
    };

// constructor for StringBuffer class
    org.apache.myfaces.dateformat.StringBuffer = function (s) {
        if (s == null)
            this.str = "";
        else
            this.str = s;

        var proto = org.apache.myfaces.dateformat.StringBuffer.prototype;
...
// Constructor for SimpleDateFormatter class
    org.apache.myfaces.dateformat.SimpleDateFormatter = function (pattern, symbols, firstDayOfWeek) {
...
// attaches methods and constants to.
    {
        var proto = org.apache.myfaces.dateformat.SimpleDateFormatter.prototype;
        ...
        proto._getIsoWeekDate = function (date) {
            ...
            if (n < 0) {
                ...
                return new org.apache.myfaces.dateformat.WeekDate(year - 1, resultWeek);
            }
            else if (n > (364 + s)) {
                // next year
                var resultWeek = 1;
                ...
                return new org.apache.myfaces.dateformat.WeekDate(year, resultWeek);
            }
        };
        ...
        proto._getWeekDate = function (date, firstDayOfWeek) {
            ...
            if (dayOffset < pivotOffset) {
                ...
                if ((pivotOffset == 3) || ((pivotOffset == 2) && prevIsLeapYear)) {
                    return new org.apache.myfaces.dateformat.WeekDate(year - 1, 53);
                }
                return new org.apache.myfaces.dateformat.WeekDate(year - 1, 52);
            }
            ...
            if ((weekNumber < 53)
                ...
                return new org.apache.myfaces.dateformat.WeekDate(year, weekNumber);
            }
            else {
                return new org.apache.myfaces.dateformat.WeekDate(year + 1, 1);
            }
        };
        ...
        proto._getDateForWeekDate = function (year, week, day, hour, min, sec, firstDayOfWeek) {
        ...
        proto._parseOps = function (symbols, yearIsWeekYear, firstDayOfWeek, ops, dateStr) {
            var context = new org.apache.myfaces.dateformat.ParserContext(firstDayOfWeek);
        ...
        proto._parsePattern = function (symbols, yearIsWeekYear, context, patternSub, dateStr, dateIndex) {
        ...
        proto._formatOps = function (symbols, yearIsWeekYear, firstDayOfWeek, ops, date) {
            ...
            var str = new org.apache.myfaces.dateformat.StringBuffer();
        ...
        proto._formatPattern = function (symbols, context, patternSub, yearIsWeekYear, out) {
            var c = patternSub.charAt(0);
            var patlen = patternSub.length;
        ...
        proto._analysePattern = function (pattern) {
            ...
            while (patternIndex < patternLen) {
                ...
                if (currentChar == '\'' && lastChar != '\\') {
                    ...
                    if (patternSub == null) {
                        patternSub = new org.apache.myfaces.dateformat.StringBuffer("q:");
                    }
                    ...
                    if (currentChar == '\\' && lastChar != '\\') {
                        ...
                        if (patternSub == null) {
                            if (this._isLetter(currentChar)) {
                                patternSub = new org.apache.myfaces.dateformat.StringBuffer("f:");
                            }
                            else {
                                patternSub = new org.apache.myfaces.dateformat.StringBuffer("l:");
                            }
                        }
...
// Constructor for SimpleDateFormatter class
        proto._construct = function (pattern, symbols, firstDayOfWeek) {
            if (symbols == null) {
                this.symbols = new org.apache.myfaces.dateformat.DateFormatSymbols();
            }
            else {
