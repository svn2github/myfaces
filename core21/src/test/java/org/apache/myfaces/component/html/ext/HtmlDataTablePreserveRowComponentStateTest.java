...
public class HtmlDataTablePreserveRowComponentStateTest extends AbstractJsfTestCase
{
    ...
    public void testPreserveRowComponentState1() throws Exception
    {
        ...
        for (int i = 0; i < model.size(); i++)
        {
            ...
            text.getTransientStateHelper().putTransient("transientText", i);
        }
        ...
        for (int i = 0; i < model.size(); i++)
        {
            ...
            assertEquals(i, text.getTransientStateHelper().getTransient("transientText"));
        }
    ...
    public void testPreserveRowComponentState2() throws Exception
    {
        ...
        for (int i = 0; i < model.size(); i++)
        {
            table.setRowIndex(i);
            assertEquals(model.get(i).getStyle(), text.getAttributes().get("style"));
            assertEquals(i<1?i:i+1, text.getTransientStateHelper().getTransient("transientText"));
        }
    ...
    public void testPreserveRowComponentStateDetailStamp1() throws Exception
    {
        ...
        for (int i = 0; i < model.size(); i++)
        {
            ...
            text.getTransientStateHelper().putTransient("transientText", i);
            detailStampText.getTransientStateHelper().putTransient("transientText", i);
        }
        ...
        for (int i = 0; i < model.size(); i++)
        {
            ...
            assertEquals(i, text.getTransientStateHelper().getTransient("transientText"));
            assertEquals(i, detailStampText.getTransientStateHelper().getTransient("transientText"));
        }
    ...
    public void testPreserveRowComponentStateDetailStamp2() throws Exception
    {
        ...
        for (int i = 0; i < model.size(); i++)
        {
            ...
            assertEquals(model.get(i).getStyle(), detailStampText.getAttributes().get("style"));
            assertEquals(i<1?i:i+1, text.getTransientStateHelper().getTransient("transientText"));
            assertEquals(i<1?i:i+1, detailStampText.getTransientStateHelper().getTransient("transientText"));
            assertTrue(text.getTransientStateHelper().getTransient("transientText").equals(
                    detailStampText.getTransientStateHelper().getTransient("transientText")));
        }
